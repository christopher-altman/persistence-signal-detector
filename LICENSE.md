...
Copyright © 2026 Christopher Altman. All rights reserved.
...
Unless inventor grants prior written permission, you may **not**:

- use this repository or any substantial portion of it for commercial purposes;
- deploy this code, in whole or in part, in any production system or commercial service;
- sell, sublicense, repackage, or redistribute this repository as a software product;
- create or distribute derivative software systems based substantially on this repository for commercial or production use;
- remove attribution, authorship, or rights notices;
- represent this repository as open-source.

## Research-use and safety notice

This repository is a research framework and public research artifact. It is **not** a deployment-ready safety tool, certification system, or validated detector of consciousness, sentience, or moral status.

## Attribution

Any permitted reference to this repository should preserve attribution to:

**Christopher Altman**

## Contact

For licensing, permissions, collaboration, or commercial inquiries, contact:
