...
\begin{document}
	...
	detect problematic objective structure before such behaviors become
	...
	non-separability in the trained QBM's latent representation: a terminal
	continuation objective should induce stronger statistical coupling across
	hidden-unit subsystems than a merely instrumental continuation strategy.
	...
	pressure---a complementary question about restructuring rather than static
	class separation. In the retained shutdown-only summary, Type~A agents show
	...
	learned latent representation is shared across agents or remains
	...
	The previous subsections characterized the signal itself; these controls
	test the boundary conditions of the current release. The experimental subset
	does not satisfy the full deployment envelope.
